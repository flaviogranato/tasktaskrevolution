...
impl ResourceState for Available {
    fn can_assign(&self) -> bool { true }
    fn can_deactivate(&self) -> bool { true }
    fn can_reactivate(&self) -> bool { false }
    fn display_name(&self) -> &'static str { "Available" }
    fn assignment_count(&self) -> usize { 0 }
}
...
impl ResourceState for Assigned {
    ...
    fn can_deactivate(&self) -> bool { true }
    fn can_reactivate(&self) -> bool { false }
    fn display_name(&self) -> &'static str { "Assigned" }
    fn assignment_count(&self) -> usize { self.project_assignments.len() }
}
...
impl ResourceState for Inactive {
    fn can_assign(&self) -> bool { false }
    fn can_deactivate(&self) -> bool { false }
    fn can_reactivate(&self) -> bool { true }
    fn display_name(&self) -> &'static str { "Inactive" }
    fn assignment_count(&self) -> usize { 0 }
}
