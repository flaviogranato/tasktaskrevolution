...
mod tests {
    ...
    fn test_layoff_period_serialize() {
        let layoff_period = LayoffPeriod {
    ...
    fn test_layoff_period_deserialize() {
        ...
        let deserialized: LayoffPeriod = serde_yml::from_str(yaml).unwrap();
...
- startDate: "2024-07-01"
  endDate: "2024-07-31"
"#;
        let deserialized: VacationRules = serde_yml::from_str(yaml).unwrap();
...
"#;
        ...
        assert_eq!(manifest.spec.status, ProjectStatus::InProgress);
...
"#,
    ...
    fn test_project_spec_serialize_with_all_fields() {
        ...
        let vacation_rules = Some(VacationRules {
